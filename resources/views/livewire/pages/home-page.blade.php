<div x-data="{comment : false, description : false}" class="">
        ...
        <div class="grid-display">
            ...
            <div class="shadow-md">
                ...
                <div class="p-5 space-y-3">
                    <h1 @click="description = !description" class="text-lg cursor-pointer">{{$book->name}}.</h1>
                    <h1>By: <span class="text-sm"> {{$book->author}}.</span></h1>

                    <div x-show="description" class="w-full" x-cloak>
                        {{$book->description}}
                    </div>
                    ...
                    <div class="flex justify-between ">
                        <div class="flex gap-5 lg:gap-3">
                            ...
                            <div @click="comment = !comment" class="cursor-pointer">
                    ...
                    <div x-show="comment" class="w-full flex  items-center" x-cloak>
