<div>
    <div x-data="{options : false , deleteModal : false}" class="wrapper">
        ...
        <div class="grid-display mt-10">
            ...
            <div class="shadow-md relative z-0">
                ...
                <div class="p-5 space-y-3">
                    ...
                    <div x-show="options" @click.away="options = false" class="bg-white absolute top-11 right-2 p-3 rounded-sm" x-cloak>
                        <ul class="space-y-2">
